<template>
  <view class="page-mines">
    ...
    <view class="actions">
      ...
      <nut-button plain type="primary" size="small" @click="go('/pages/training/index')">阶梯训练</nut-button>
      <nut-button plain type="primary" size="small" @click="go('/pages/reading/terms')">规范词库</nut-button>
    </view>
...
function goEdit(id?: string) {
  Taro.navigateTo({ url: id ? `/pages/training/analyze?id=${id}` : '/pages/training/analyze' })
}
