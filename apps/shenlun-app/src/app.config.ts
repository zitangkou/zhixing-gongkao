export default defineAppConfig({
  pages: ['pages/today/index', 'pages/reading/index', 'pages/reading/detail', 'pages/reading/mines', 'pages/reading/terms', 'pages/training/index', 'pages/training/analyze', 'pages/training/answer', 'pages/profile/index', 'pages/auth/login', 'pages/auth/register'],
  window: {
