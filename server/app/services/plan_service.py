...
DEFAULT_BY_DAY: dict[str, list[dict]] = {
    "mon": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜English with Lucy 3-5分钟，模仿更夸张并录音", 10, 3),
        _t("12:30-13:00", "阅读", "自由阅读《史记》｜纯享受，不想读就放下", 30, 2),
    ...
    "tue": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜同一片段跟读2-3天再换新", 10, 3),
        _t("12:30-13:00", "阅读", "自由阅读《史记》｜可跳读，按自己节奏", 30, 2),
    ...
    "wed": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜可换口音增加趣味", 10, 3),
        _t("12:30-13:00", "阅读", "自由阅读《史记》", 30, 2),
        _t("13:00-13:30", "休息", "午睡", 30, 5),
        _t("18:20-20:00", "行测", "考公·行测弱项专练｜对照此前正确率", 100, 5),
        _t("20:00-20:15", "健身", "康复锻炼｜靠墙静蹲+弹力带划船+臀桥；饭后1小时，不适即停", 15, 2),
    ...
    "thu": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜坚持录音对比", 10, 3),
        _t("12:30-13:00", "阅读", "自由阅读《史记》", 30, 2),
        _t("13:00-13:30", "休息", "午睡", 30, 5),
    ...
    "fri": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜本周最后旧片段，下周换新", 10, 3),
        _t("12:30-13:00", "阅读", "自由阅读《史记》｜感兴趣人物多停留", 30, 2),
        _t("13:00-13:30", "休息", "午睡", 30, 5),
    ...
    "sat": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜可换影视片段，重点开口", 10, 3),
    ...
    "sun": [
        ...
        _t("07:15-07:25", "英语", "英语夸张跟读｜可换新材料", 10, 3),
        _t("09:00-09:40", "申论", "申论范文拆解｜划论点+规范词/论证方法+口述主旨录音", 40, 5),
        _t("09:40-09:50", "英语", "英语衔接复述｜用最简单英语复述主旨并录音", 10, 3),
        _t("10:00-11:00", "行测", "行测模考深度复盘｜逐题看解析，记录高频错因", 60, 5),
        _t("14:00-14:20", "英语", "英语TED跟读｜关字幕听2遍，开字幕跟读2遍", 20, 3),
        _t("14:20-15:00", "英语", "TED模仿3句｜模仿手势语气，录音到满意", 40, 3),
        _t("15:00-15:30", "健身", "周末康复锻炼｜静蹲+划船+臀桥，动作标准第一", 30, 2),
        _t("16:00-16:20", "健身", "滑板奖励｜平地慢滑/荡板戴护具；不适改看教学", 20, 2),
