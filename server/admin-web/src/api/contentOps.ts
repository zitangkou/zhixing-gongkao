...
export interface ContentPackage { id: string; productKey: string; templateId: string; sourceType: string; sourceId: string; sourceTitle: string; campaignKey: string; deepLink: string; variants: Record<string, ContentVariant>; reviewNote: string; status: ContentOpsStatus; plannedAt?: string; publishedAt?: string; createdAt: string; updatedAt: string }
